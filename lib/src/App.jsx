...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {currentPage === 'messages' && <MessageCheck setCurrentPage={setCurrentPage} />}
      {currentPage === 'urls' && <UrlCheck setCurrentPage={setCurrentPage} />}
      {currentPage === 'images' && <ImageCheck setCurrentPage={setCurrentPage} />}
