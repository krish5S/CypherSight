...
import { api, UrlResponse } from '../lib/api'
import { LinkIcon, ShieldAlert, CheckCircle2, AlertTriangle, ArrowRight, Activity, Globe } from 'lucide-react'
  ...
  return (
    <main className="container mx-auto px-4 py-8 md:py-12">
      ...
      <div className="mb-10 text-center max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight">URL Analysis</h1>
        <p className="text-slate-400">
          Paste a target URL below to assess fraud likelihood, domain age, and heuristic threat markers.
        </p>
      </div>
        ...
        <div className="flex flex-col">
          <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 shadow-2xl flex-1 flex flex-col relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 mb-4">
               ...
               <h2 className="font-semibold text-white tracking-wide">Target URL</h2>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl bg-slate-950/50 border border-slate-800 text-slate-200 placeholder-slate-600 focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 focus:outline-none font-mono text-sm"
              />
            </div>
            
            <div className="flex items-center justify-between gap-4 mt-auto pt-8">
              <div className="text-xs text-slate-500 flex items-center gap-1">
                 <ShieldAlert className="w-4 h-4" /> Tip: include http/https
              </div>
              <button
          ...
          <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 shadow-2xl flex-1 relative flex flex-col bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-800/20 via-slate-900/0 to-slate-900/0">
            ...
            {!result && !errorMsg && (
              <div className="flex-1 flex flex-col items-center justify-center text-slate-500 min-h-[250px] border-2 border-dashed border-slate-800 rounded-xl bg-slate-950/20">
                ...
                <p className="text-sm mt-1">Submit a URL to view the risk profile</p>
              </div>
            )}
                ...
                {result.domain_age_days !== null && (
                  <div className="flex items-center justify-between p-4 rounded-xl bg-slate-900 border border-slate-800">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-slate-300">Domain Age</span>
                    </div>
                    <span className={`font-mono font-bold ${result.domain_age_days < 30 ? 'text-rose-400' : 'text-emerald-400'}`}>
